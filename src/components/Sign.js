  ...
  return (
    <>
      { //Conditional Rendering if form is successfully validated
        ...
        <div className="alert alert-success alert-dismissible fade show fs-5" role="alert">
      ...
      <section className='section_sign py-5'>
        <main className="form-signin border rounded">
          <form onSubmit={handleSubmit}>
            ...
            <h1 className="h3 mb-3 fw-normal"> <span className='text-black'>Sign In</span> <span className='text-success'>Safely</span></h1>
            ...
            <div className="form-floating mt-3">
              <input type="email" className="form-control" id="email" placeholder="Your Email" values={ formValues.email } onChange={handleChange} autoComplete='on' />
              <label htmlFor="email">Email address</label>
              <p className='error ms-1 mt-1'>{ formErrors.email }</p>
            </div>

            <div className="form-floating mt-3">
              <input type="password" className="form-control" id="password" placeholder="Password" values={ formValues.password } onChange={handleChange} autoComplete='on' />
              <label htmlFor="password">Password</label>
              <p className='error ms-1 mt-1'>{ formErrors.password }</p>
            </div>

            <div className="form-floating mt-3">
              <input type="password" className="form-control" id="password2" placeholder="Confirm Password" values={ formValues.password } onChange={handleChange} autoComplete='on' />
              <label htmlFor="password2">Confirm Password</label>
              <p className='error ms-1 mt-1'>{ formErrors.password2 }</p>
            </div>

            <div className="mb-3 form-check mt-3">
              <input type="checkbox" className="form-check-input" id="check" onClick={handleChange} />
